...
const RightSideBar = () => {
  ...
  return (
    <div className="hidden lg:flex lg:flex-col">
      <div className="dark:bg-[#16181C] bg-stone-500 rounded-full w-72 flex mx-6 justify-center items-center my-4 px-3 py-1 focus:outline-sky-500 fixed z-50 ring-1 ring-orange-400 ">
